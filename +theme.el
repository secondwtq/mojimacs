;;; ~/.config/doom/+theme.el -*- lexical-binding: t; -*-

;;; doom-one-light-theme.el --- inspired by Atom One Light
(require 'doom-themes)

;;
(defgroup doom-one-light-mod-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom doom-one-light-mod-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-one-light-mod-theme
  :type 'boolean)

(defcustom doom-one-light-mod-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-one-light-mod-theme
  :type 'boolean)

(defcustom doom-one-light-mod-comment-bg doom-one-light-mod-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'doom-one-light-mod-theme
  :type 'boolean)

(defcustom doom-one-light-mod-padded-modeline doom-themes-padded-modeline
...
;;
(def-doom-theme doom-one-light-mod
  ...
  ((bg         '("#fafafa" nil       nil            ))
   ...
   (selection      dark-blue)
   (builtin        magenta)
   (comments       (if doom-one-light-mod-brighter-comments cyan base4))
   ...
   ;; custom categories
   (-modeline-bright doom-one-light-mod-brighter-modeline)
   (-modeline-pad
    (when doom-one-light-mod-padded-modeline
      (if (integerp doom-one-light-mod-padded-modeline) doom-one-light-mod-padded-modeline 4)))
  ...
  ((font-lock-comment-face
    :foreground comments
    :background (if doom-one-light-mod-comment-bg base0))
   (font-lock-doc-face
